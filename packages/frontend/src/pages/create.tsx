...
export const Create: React.FC = () => {
  ...
  const createNft = async () => {
    ...
    const { contractAddress } = getNetworkConfig(chainId as ChainIdType);
    const choco = {
      chainId,
    ...
    const messageHash = ethers.utils.solidityKeccak256(
      ...
      [chainId, choco.contractAddress, imageDigest, choco.iss]
    );
    choco.tokenId = ethers.BigNumber.from(messageHash).toString();
    const imageCid = imageUrl.split("://")[1];
    choco.name = `NFT#${imageCid}`;
    ...
    await contract.mint(imageDigest);
    console.log("tokenId", choco.tokenId);
  };

  return (
    <div className="container mx-auto h-screen bg-white p-40">
      <div>
        ...
        {modalDisplay && (
          <div className="absolute fixed z-20 inset-0">
            <div className="flex min-h-screen p-4">
              ...
              <div className="flex bg-white rounded-lg w-full mx-auto shadow-2xl transform">
